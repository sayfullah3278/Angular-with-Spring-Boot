...
export class PdfComponent implements OnInit {
  ...
  private calculateTotal(): void {
    ...
    let bedfee = this.bill.daily_cost
    let result = days * docFee
    let resultBed = days*bedfee;
    document.getElementById("totalPriceLarge")!.innerHTML = result.toFixed(1);
    document.getElementById("totalPriceMid")!.innerHTML = resultBed.toFixed(1);

    
    let result2 = resultBed + result
